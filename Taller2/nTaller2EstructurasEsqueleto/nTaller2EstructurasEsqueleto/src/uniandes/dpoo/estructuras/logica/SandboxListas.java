...
public class SandboxListas
{
    ...
    {
    	posicion = Math.clamp(posicion, 0, listaEnteros.size());
    ...
    {
    	for (int i = 0; i < listaEnteros.size(); i++) {
    		int value = Math.abs(listaEnteros.get(i));
    		listaEnteros.set(i, value);
    	}
    }
    ...
    {
    	List<Integer> otraLista = new ArrayList<Integer>();
        for (int elemento : otroArreglo) {
        	otraLista.add(elemento);
        }
        
        return listaEnteros.equals(otraLista);
    }
